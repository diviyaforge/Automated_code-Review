// ─── CODE EXPLANATION ─────────────────────────────────────────────────────────
// Renders the Code Explanation feature page.
// The actual API call lives in Dashboard.jsx (handleReview).
// This component only handles display — it receives results via props.
...
const FEATURE = {
  ...
  icon: "📄",
  description: "Explains what your code does in plain English.",
  color: "#7C6FCD",
};

export default function CodeExplanation({ code, isAnalyzing, analysisResult, analysisLabel, onReview, onSave, batchResult }) {
      ...
      {code && code.trim() ? (
        ...
        <div style={{ ...s.card, alignItems: "center", justifyContent: "center", minHeight: "280px", gap: "14px" }}>
          ...
          <p style={{ color: "#64748b", fontSize: "13px", textAlign: "center", maxWidth: "320px", lineHeight: "1.6" }}>
            Go to <strong style={{ color: "#c4b5fd" }}>Home</strong>, paste or upload your code, then come back here to run this analysis.
          </p>
        </div>
      )}
    </div>
