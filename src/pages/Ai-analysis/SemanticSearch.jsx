...
const FEATURE = {
  ...
  icon: "🔍",
  description: "Find patterns, functions, or logic within your code.",
  color: "#7C6FCD",
};

export default function SemanticSearch({ code, isAnalyzing, analysisResult, analysisLabel, onReview, onSave, batchResult }) {
