...
const FEATURE = {
  ...
  label: "Bug Detection",
  icon: "🐛",
  description: "Scans your code for bugs, errors, and logical issues.",
  color: "#7C6FCD",
};

export default function BugDetection({ code, isAnalyzing, analysisResult, analysisLabel, onReview, onSave, batchResult }) {
